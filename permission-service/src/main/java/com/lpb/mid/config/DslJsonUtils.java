...
public final class DslJsonUtils {
    ...
    public static <T> byte[] encode(T obj, JsonWriter.WriteObject<T> objectWriter) {
        JsonWriter jsonWriter = localJsonWriter.get();
        try {
    ...
    public static byte[] encode(Object obj) {
        ...
        throw new RuntimeException("Can't encode json object of type: " + obj.getClass());
    }
    ...
    public static void encode(Object obj, OutputStream outputStream) {
        if (obj == null) {
            try {
                ...
                throw new RuntimeException("Can't encode json object");
            }
        }
        JsonWriter jsonWriter = localJsonWriter.get();
    ...
    public static <T> T decode(InputStream inputStream, Class<T> clazz) {
        try {
            ...
            throw new RuntimeException("can't decode json");
        }
    }
    ...
    public static <T> T decode(InputStream inputStream, final JsonReader.ReadObject<T> objectReader) {
        JsonReader<?> jsonReader = localJsonReader.get();
        try {
